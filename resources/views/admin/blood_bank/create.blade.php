...
@section('title','Road Helper | Blood Bank Create')
@section('css')
    ...
    <div class="row">
        ...
        <div class="col-md-10 offset-1">
          ...
          <div class="card">
            ...
            <form data-action="{{ route('blood_bank.store') }}" method="post" id="add_blood_bank_form">
              @csrf
              <div class="card-body">
                <div class="row">
...
<script src="{{asset('assets/backend/style/js/summernote.js')}}"></script>
  <script>
    ...
    $(document).ready(function(){
        $('body').on('submit','#add_blood_bank_form',function(e){
