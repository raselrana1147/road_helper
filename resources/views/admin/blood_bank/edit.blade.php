...
@section('title','Road Helper | Update Blood Bank')
@section('css')
...
<section class="content">
  <div class="container-fluid">
    <div class="row">
        ...
        <form data-action="{{ route('blood_bank.update') }}" method="post" id="update_bank_form">
          @csrf
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="bank_name" required="" value="{{$item->bank_name}}">
              </div>
...
<script src="{{asset('assets/backend/style/js/summernote.js')}}"></script>
  <script>
    $(document).ready(function(){
        $('body').on('submit','#update_bank_form',function(e){
