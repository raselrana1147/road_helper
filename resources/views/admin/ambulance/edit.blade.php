...
@section('title','Road Helper | Update Ambulance')
@section('css')
  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 offset-1">
         ...
         <form data-action="{{ route('ambulance.update') }}" method="post" id="update_ambulance_form">
              @csrf
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="company_name" required="" required="" value="{{$item->company_name}}">
                  </div>
