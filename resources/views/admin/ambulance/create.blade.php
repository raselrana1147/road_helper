...
@section('title','Road Helper | Add Ambulance')
@section('css')
    ...
    <div class="row">
        ...
        <div class="col-md-10 offset-1">
          ...
          <div class="card">
            ...
            <form data-action="{{ route('ambulance.store') }}" method="post" id="add_ambulance_form">
              @csrf
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    <label >Company Name Or driver Name</label>
...
<script src="{{asset('assets/backend/style/js/summernote.js')}}"></script>
  ...
  <script>
    ...
    $(document).ready(function(){
        $('body').on('submit','#add_ambulance_form',function(e){
