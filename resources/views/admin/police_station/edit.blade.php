...
@section('title','Road Helper | Update Police Station')
@section('css')
    ...
    <div class="row">
        ...
        <div class="col-md-10 offset-1">
          ...
          <div class="card">
            ...
            <form data-action="{{ route('police_station.update') }}" method="post" id="update_police_station_form">
              @csrf
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <input type="text" class="form-control" name="station_name" required="" value="{{$item->station_name}}">
                </div>
               ...
               <div class="form-group col-12">
                      ...
                      <label >Address</label>
                     <textarea id="summernote" required="" name="address">{{$item->address}}</textarea>
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-success" id="submit_button">Updare</button>
...
<script src="{{asset('assets/backend/style/js/summernote.js')}}"></script>
  <script>
    ...
    $(document).ready(function(){
        $('body').on('submit','#update_police_station_form',function(e){
