...
@section('title','Road Helper | Add Police Station')
@section('css')
    ...
    <div class="row">
        ...
        <div class="col-md-10 offset-1">
          ...
          <div class="card">
            ...
            <form data-action="{{ route('police_station.store') }}" method="post" id="add_police_station_form">
              @csrf
              <div class="card-body">
              <div class="row">
 ...
 <script src="{{asset('assets/backend/style/js/summernote.js')}}"></script>
  <script>
    ...
    $(document).ready(function(){
        $('body').on('submit','#add_police_station_form',function(e){
                ...
                $.ajax({
                  ...
                  success:function(response){
                    ...
                    $("#add_police_station_form")[0].reset(); 
                    $('#submit_button').text("Add").prop('disabled',false);
                  },
