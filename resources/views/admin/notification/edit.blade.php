...
@section('title','Road Helper | Update Notification')
@section('css')
...
<section class="content">
  <div class="container-fluid">
    <div class="row">
        ...
        <form data-action="{{ route('notification.update') }}" method="post" id="update_notification_form">
          @csrf
          ...
          <div class="card-body">
              ...
              <div class="form-group col-12">
                <label>Subject</label>
                <input type="text" class="form-control" name="subject" required="" value="{{$item->subject}}">
              </div>

              <div class="form-group col-12">
                     <label>Content</label>
                <textarea class="form-control" name="content" cols="10" required="" rows="1" id="content_text">{!!$item->content!!}</textarea>
              </div>
...
<script src="{{asset('backend/plugins/summernote/summernote-bs4.min.js')}}"></script>
  <script>
    ...
    $(document).ready(function(){
        ...
        $('body').on('submit','#update_notification_form',function(e){
