...
@section('title','Road Helper | Update Hospital')
@section('css')
  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 offset-1">
         ...
         <form data-action="{{ route('hospital.update') }}" method="post" id="update_hospital_form">
              @csrf
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="hospital_name" required="" value="{{$item->hospital_name}}">
                  </div>
...
<script src="{{asset('assets/backend/style/js/summernote.js')}}"></script>
  <script>
    ...
    $(document).ready(function(){
        $('body').on('submit','#update_hospital_form',function(e){
