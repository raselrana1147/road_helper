...
@section('title','Road Helper | Add Touring Place')
@section('css')
    ...
    <div class="row">
        ...
        <div class="col-md-10 offset-1">
          ...
          <div class="card">
            ...
            <form data-action="{{ route('touring_place.store') }}" method="post" id="add_touring_place_form" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <label for="inputName2" class="col-sm-2 col-form-label">Image</label>
                          <div class="col-sm-10">
                              <input type="file" class="form-control dropify" name="image"  data-default-file="{{ asset('assets/backend/touring/default.png')}}">
                          </div>
...
@section('js')
  ...
  <script>
    $(document).ready(function(){
        $('body').on('submit','#add_touring_place_form',function(e){
                ...
                $.ajax({
                  ...
                  success:function(response){
                    ...
                    $("#add_touring_place_form")[0].reset();
                    $('#submit_button').text("Add").prop('disabled',false);
                  },
