...
@section('title','Road Helper | Add Division')
@section('breadcrumb')
  <div class="row mb-2">
    <div class="col-sm-6">
    ...
    <div class="row">
        ...
        <div class="col-md-10 offset-1">
          ...
          <div class="card">
            ...
            <form data-action="{{ route('division.store') }}" method="post" id="add_division_form">
              @csrf
              <div class="card-body">
...
@section('js')
  <script>
    ...
    $(document).ready(function(){
        $('body').on('submit','#add_division_form',function(e){
